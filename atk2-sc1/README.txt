		...
		TOPPERS/ATK2-SC1（Release 1.3.2）
        ＜ATK2-SC1 Readmeファイル＞
...
$Id: README.txt 1801 2015-03-27 06:34:43Z t_ishikawa $
----------------------------------------------------------------------
...
ATK2-SC1 Release 1.3.0以降では，TOPPERS新世代カーネル用コンフィギュレー
タ（cfg）(ジェネレータと呼ぶ)の最新版（1.9.4）の機能を用いている．
1.9.3以前のバージョンでは動作しないので注意すること．
