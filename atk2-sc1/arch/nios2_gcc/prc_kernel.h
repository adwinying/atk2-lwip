 ...
 *  の責任を負わない．
 *
 *  $Id: prc_kernel.h 1801 2015-03-27 06:34:43Z t_ishikawa $
 */

/*
 *		Os.hのプロセッサ依存部（Nios2用）
 *
...
extern uint32	nios2_cpu_exp_no;

/* CPU例外発生時，プログラムカウンタ（PC - 4）を保持する変数 */
extern uint32	nios2_cpu_exp_pc;

/* CPU例外発生時，CPU例外発生箇所（アドレス）を保持する変数 */
extern uint32	nios2_cpu_exp_bad_addr;

/* CPU例外発生時，スタックポインタを保持する変数 */
extern uint32	nios2_cpu_exp_sp;
