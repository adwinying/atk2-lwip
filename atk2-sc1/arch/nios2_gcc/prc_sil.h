 ...
 *  の責任を負わない．
 *
 *  $Id: prc_sil.h 1801 2015-03-27 06:34:43Z t_ishikawa $
 */
...
TOPPERS_disint(void)
{
	...
	Asm("wrctl status, %0" :: "r" (TOPPERS_status & (~(0x0001U))) : "memory");
...
{
	return((uint8) __builtin_ldbuio(mem));
}

LOCAL_INLINE void
sil_wrb_iop(void *mem, uint8 data)
{
...
{
	return((uint16) __builtin_ldhuio(mem));
}

LOCAL_INLINE void
sil_wrh_iop(void *mem, uint16 data)
{
