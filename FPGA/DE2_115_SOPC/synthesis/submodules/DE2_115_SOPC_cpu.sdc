...
set 	DE2_115_SOPC_cpu_oci_im 	DE2_115_SOPC_cpu_nios2_oci_im:the_DE2_115_SOPC_cpu_nios2_oci_im
set 	DE2_115_SOPC_cpu_oci_traceram 	DE2_115_SOPC_cpu_traceram_lpm_dram_bdp_component_module:DE2_115_SOPC_cpu_traceram_lpm_dram_bdp_component
set 	DE2_115_SOPC_cpu_oci_itrace 	DE2_115_SOPC_cpu_nios2_oci_itrace:the_DE2_115_SOPC_cpu_nios2_oci_itrace
set 	DE2_115_SOPC_cpu_oci_im_path 	 [format "%s|%s" $DE2_115_SOPC_cpu_oci_path $DE2_115_SOPC_cpu_oci_im]
set 	DE2_115_SOPC_cpu_oci_itrace_path 	 [format "%s|%s" $DE2_115_SOPC_cpu_oci_path $DE2_115_SOPC_cpu_oci_itrace]
set 	DE2_115_SOPC_cpu_traceram_path 	 [format "%s|%s" $DE2_115_SOPC_cpu_oci_im_path $DE2_115_SOPC_cpu_oci_traceram]
...
set_false_path -from [get_keepers *$DE2_115_SOPC_cpu_oci_break_path|dbrk_hit?_latch] -to [get_keepers *$DE2_115_SOPC_cpu_jtag_sr*]
set_false_path -from [get_keepers *$DE2_115_SOPC_cpu_oci_break_path|trigbrktype] -to [get_keepers *$DE2_115_SOPC_cpu_jtag_sr*]
set_false_path -from [get_keepers *$DE2_115_SOPC_cpu_oci_break_path|trigger_state] -to [get_keepers *$DE2_115_SOPC_cpu_jtag_sr*]

set_false_path -from [get_keepers *$DE2_115_SOPC_cpu_traceram_path*address*] -to [get_keepers *$DE2_115_SOPC_cpu_jtag_sr*]
set_false_path -from [get_keepers *$DE2_115_SOPC_cpu_traceram_path*we_reg*] -to [get_keepers *$DE2_115_SOPC_cpu_jtag_sr*]
set_false_path -from [get_keepers *$DE2_115_SOPC_cpu_oci_im_path|*trc_im_addr*] -to [get_keepers *$DE2_115_SOPC_cpu_jtag_sr*]
set_false_path -from [get_keepers *$DE2_115_SOPC_cpu_oci_im_path|*trc_wrap] -to [get_keepers *$DE2_115_SOPC_cpu_jtag_sr*]
set_false_path -from [get_keepers *$DE2_115_SOPC_cpu_oci_itrace_path|trc_ctrl_reg*] -to [get_keepers *$DE2_115_SOPC_cpu_jtag_sr*]
set_false_path -from [get_keepers *$DE2_115_SOPC_cpu_oci_itrace_path|d1_debugack] -to [get_keepers *$DE2_115_SOPC_cpu_jtag_sr*]
